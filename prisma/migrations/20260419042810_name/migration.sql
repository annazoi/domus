...
CREATE TABLE "documents" (
    "id" TEXT NOT NULL,
    "user_id" TEXT NOT NULL,
    "property_image_id" TEXT NOT NULL,
...
-- AddForeignKey
ALTER TABLE "documents" ADD CONSTRAINT "documents_property_image_id_fkey" FOREIGN KEY ("property_image_id") REFERENCES "property_images"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
