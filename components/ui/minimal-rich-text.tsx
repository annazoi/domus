...
export function MinimalRichText({
	...
	return (
		<div className="space-y-1.5">
			...
			<div className="overflow-hidden rounded-xl border border-black/10 bg-white transition hover:border-[#6B705C]/25 focus-within:border-[#6B705C]/40 focus-within:ring-2 focus-within:ring-[#6B705C]/12">
				{editor ? (
