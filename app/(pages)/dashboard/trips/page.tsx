		...
		<div className="space-y-8">
			...
			{loading ? (
				<div className="dashboard-panel overflow-hidden rounded-2xl">
					<div className="hidden grid-cols-4 gap-4 border-b border-dashboard-border px-5 py-3 md:grid">
					...
					{Array.from({ length: 4 }).map((_, index) => (
						<div key={index} className="grid grid-cols-1 gap-2 border-b border-dashboard-border px-5 py-4 md:grid-cols-4 md:gap-4">
