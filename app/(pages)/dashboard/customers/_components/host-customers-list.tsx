			...
			{customers.map((customer) => {
				...
				return (
					<Button
						...
						key={customer.id}
						variant="custom"
						className="cursor-pointer flex h-auto w-full flex-col items-start gap-2 border-b border-dashboard-border px-5 py-5 text-left font-normal transition hover:bg-dashboard-row-hover last:border-b-0 md:flex-row md:flex-wrap md:items-baseline md:gap-x-8 md:gap-y-2 md:px-8 md:py-6 lg:gap-x-12 lg:px-10"
