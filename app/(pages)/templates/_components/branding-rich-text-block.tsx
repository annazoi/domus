...
const linkStyles =
	'[&_a]:font-medium [&_a]:underline [&_a]:underline-offset-2 [&_a]:decoration-current/35 hover:[&_a]:decoration-current/70';
...
const variantStyles = {
	...
	architectura:
		`font-[family-name:var(--preview-kaze-body)] text-base leading-relaxed text-[#1c2430]/70 sm:text-lg [&_strong]:font-semibold [&_em]:italic [&_ul]:my-3 [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:my-3 [&_ol]:list-decimal [&_ol]:pl-5 [&_p]:my-2 [&_p:first-child]:mt-0 [&_p:last-child]:mb-0 ${linkStyles}`,
} as const;
